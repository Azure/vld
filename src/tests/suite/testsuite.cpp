...
static UINT MAXALLOC = 0;                     // Maximum number of allocations of each type to perform, per thread
static UINT NUMTHREADS = 0;                   // Number of threads to run simultaneously
static ULONG MAXBLOCKS = 0;                    // Total maximum number of allocations, per thread
