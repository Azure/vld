...
#define VLD_OPT_REPORT_SYSTEM_ALLOCS   0x20000 //   If set, when the immediate caller is a non-reporting CRT/system module, VLD walks the call stack to attribute the allocation to user code (VLD 2.5.15 behavior). If not set, VLD excludes based solely on the immediate caller (VLD 2.5.10 behavior).
